...
CREATE TABLE GUEST
    (GID NUMBER(1) PRIMARY KEY,
    FNAME VARCHAR(20),
    LNAME VARCHAR(20),
    AGROUP NUMBER(1));

CREATE TABLE BOOKING
    (BID NUMBER(1) PRIMARY KEY,
    GID NUMBER(1) REFERENCES GUEST(GID) NOT NULL,
...
INSERT INTO BOOKING (BID, GID, ROOMNUM, CDATE, NOG)   VALUES(1, 2, 1, TO_DATE('2010/03/30', 'yyyy/mm/dd'), 3);
INSERT INTO BOOKING (BID, GID, ROOMNUM, CDATE, NOG)   VALUES(2, 3, 2, TO_DATE('2012/04/01', 'yyyy/mm/dd'), 3);

/* CHECKIN DATE TODAY -> */

/*3 GUESTS, SUPERIOR ROOM*/
INSERT INTO BOOKING (BID, GID, ROOMNUM, CDATE, NOG)   VALUES(3, 4, 1, TO_DATE('2016/03/30', 'yyyy/mm/dd'), 3);
INSERT INTO BOOKING (BID, GID, ROOMNUM, CDATE, NOG)   VALUES(4, 5, 2, TO_DATE('2016/04/01', 'yyyy/mm/dd'), 3);
INSERT INTO BOOKING (BID, GID, ROOMNUM, CDATE, NOG)   VALUES(5, 6, 3, TO_DATE('2016/04/05', 'yyyy/mm/dd'), 3);
INSERT INTO BOOKING (BID, GID, ROOMNUM, CDATE, NOG)   VALUES(6, 7, 4, TO_DATE('2016/04/06', 'yyyy/mm/dd'), 3);
INSERT INTO BOOKING (BID, GID, ROOMNUM, CDATE, NOG)   VALUES(7, 8, 5, TO_DATE('2016/04/07', 'yyyy/mm/dd'), 3);

/*2 GUESTS, SUPERIOR ROOM*/
INSERT INTO BOOKING (BID, GID, ROOMNUM, CDATE, NOG)   VALUES(8, 9, 6, TO_DATE('2016/04/08', 'yyyy/mm/dd'), 2);
INSERT INTO BOOKING (BID, GID, ROOMNUM, CDATE, NOG)   VALUES(9, 10, 7, TO_DATE('2016/04/09', 'yyyy/mm/dd'), 2);

/*1 GUEST, SUPERIOR ROOM*/
INSERT INTO BOOKING (BID, GID, ROOMNUM, CDATE, NOG)   VALUES(10, 11, 8, TO_DATE('2016/03/30', 'yyyy/mm/dd'), 1);

/*2 GUESTS, DELUXE ROOM*/
INSERT INTO BOOKING (BID, GID, ROOMNUM, CDATE, NOG)   VALUES(11, 12, 34, TO_DATE('2016/04/05', 'yyyy/mm/dd'), 2);
INSERT INTO BOOKING (BID, GID, ROOMNUM, CDATE, NOG)   VALUES(12, 13, 35, TO_DATE('2016/04/06', 'yyyy/mm/dd'), 2);

/*1 GUEST, DELUXE ROOM*/
INSERT INTO BOOKING (BID, GID, ROOMNUM, CDATE, NOG)   VALUES(13, 14, 37, TO_DATE('2016/04/08', 'yyyy/mm/dd'), 1);

/*2 GUESTS, BASIC ROOM*/
INSERT INTO BOOKING (BID, GID, ROOMNUM, CDATE, NOG)   VALUES(14, 15, 67, TO_DATE('2016/10/05', 'yyyy/mm/dd'), 2);
INSERT INTO BOOKING (BID, GID, ROOMNUM, CDATE, NOG)   VALUES(15, 16, 68, TO_DATE('2016/08/19', 'yyyy/mm/dd'), 2);

/*1 GUEST, BASIC ROOM*/
INSERT INTO BOOKING (BID, GID, ROOMNUM, CDATE, NOG)   VALUES(16, 17, 70, TO_DATE('2016/09/03', 'yyyy/mm/dd'), 1);
INSERT INTO BOOKING (BID, GID, ROOMNUM, CDATE, NOG)   VALUES(17, 18, 71, TO_DATE('2016/12/24', 'yyyy/mm/dd'), 1);
